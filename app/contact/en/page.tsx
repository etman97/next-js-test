...
export default function Page() {
  return (
    <div
      className="flex relative flex-col lg:flex-row justify-center gap-10 items-center min-h-screen w-full pt-16 p-4"
      dir="ltr">
        ...
        <div className="p-6 rounded-lg shadow-lg">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-white text-lg leading-relaxed">
              2290 Prince Saud Bin Faisal Road, Al-Sahafah District, 6118 Riyadh
            </h1>
          </div>
        </div>
